                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="col-span-12 lg:col-start-5 lg:col-span-8 xl:col-start-6 xl:col-span-7 lg:pl-10 flex flex-col items-center sm:flex-row sm:justify-between text-center sm:text-left">
                        ...
                        <div className="flex space-x-6 items-center">
                            <a href="https://github.com/Hammad-arshad18" className="text-gray-500 hover:text-white transition-colors">
                                <Github className="w-5 h-5" />
                            </a>
                            <a href="https://www.linkedin.com/in/hammad-arshad18/" className="text-gray-500 hover:text-white transition-colors">
                                <Linkedin className="w-5 h-5" />
                            </a>
                            <a href="https://wa.me/971568687899" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-[#25D366] transition-colors">
                                <svg
